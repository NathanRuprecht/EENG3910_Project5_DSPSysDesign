/*************************************************
 SPI DAC Example with MCP4921
 Generate a single-tone sine signal from LaunchPad
...
#define SAMP_FREQ    48000 // Frequency in Hz, common sampling rates for digital audio: 44100, 48000
#define SIG_FREQ    1000 // Signal frequency in Hz.
#define SIG_LEN    48 // = SAMP_FREQ/SIG_FREQ, period of discrete-time signal
...
const char *disp_text[NUM_DISP_TEXT_LINE] = {
		"\n",
		"UART and LED Demo\n",
		"H: help, R: red, G: green, B: blue. S: start sampling.  P: pause sampling. \n",
		"> " };

uint16_t sig[SIG_LEN], sig_index=0, x=0;
uint32_t sys_clock;
